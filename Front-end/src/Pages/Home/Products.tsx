...
const Products = () => {
  ...
  return (
    <div className="flex justify-center items-center w-[100%] h-[82vh] bg-[]">
      <div
        className="w-[93%] h-[77vh] bg-[#fff] p-2 rounded-[7px] flex gap-4 shadow-md"
        data-aos-duration="500"
        data-aos-once="true"
      >
        <div className="flex flex-col bg-[green] w-[16%] h-[36vh] p-2 rounded-[7px] gap-2 hover:shadow-md hover:transition-transform 
